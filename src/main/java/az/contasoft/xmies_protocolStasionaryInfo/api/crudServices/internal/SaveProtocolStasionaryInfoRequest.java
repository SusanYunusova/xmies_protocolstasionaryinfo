...
public class SaveProtocolStasionaryInfoRequest {
    ...
    public SaveProtocolStasionaryInfoRequest() {
    }

    @Override
    public String toString() {
        return "SaveProtocolStasionaryInfoRequest{" +
    ...
    public SaveProtocolStasionaryInfoRequest(long idProtocolStasionaryInfo, long idProtocol, long idBedPlaceProperty, Date stasionaryEnteredTime, Date expectedExitTime, int isDelete) {
        this.idProtocolStasionaryInfo = idProtocolStasionaryInfo;
        this.idProtocol = idProtocol;
        this.idBedPlaceProperty = idBedPlaceProperty;
        this.stasionaryEnteredTime = stasionaryEnteredTime;
